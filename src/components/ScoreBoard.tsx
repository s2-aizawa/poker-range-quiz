...
export default function ScoreBoard({ totalCorrect, totalAttempts, accuracy, onReset }: ScoreBoardProps) {
  return (
    <div className="bg-gray-800 rounded-xl p-4 text-white w-full max-w-sm">
      ...
      <div className="flex justify-around">
        ...
        <div className="text-center">
          <div className={`text-2xl font-bold ${accuracy !== null && accuracy >= 70 ? 'text-green-400' : 'text-yellow-400'}`}>
